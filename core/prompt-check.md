...
{"updates":[{"id":"<ტასკის id>","note":"<1-2 წინადადება: რა კონკრეტული ფაილი/commit შეიცვალა და რას ნიშნავს ეს ტასკისთვის>","status":"<urgent|important|planning|delayed — მხოლოდ თუ ცვლი>","done":true}],"newTasks":[{"id":"<slug-en>","title":"...","desc":"...","status":"planning","dir":"<ფოლდერის სრული გზა topDirs-იდან>"}]}
